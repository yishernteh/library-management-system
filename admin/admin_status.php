...
<div class="container">
  ...
  <div style="float: rith;" class="srch">
      ...
      if(isset($_POST['submit']))
      {
          ...
          echo "</table>"; 
          	...
          	?>
          		...
          		<button type="submit" name="submit8" style="background-color: #101010ed; color:red; font-weight: 700; font-size: 18px;" class="btn btn-default"><span style="color:red" class="glyphicon glyphicon-remove-sign"></span>&nbsp Remove</button>
          		<button type="submit" name="submit9" style="background-color: #101010ed; color:green; font-weight: 700; font-size: 18px;" class="btn btn-default"><span style="color: green" class="glyphicon glyphicon-ok-sign"></span>&nbsp Approve</button>
