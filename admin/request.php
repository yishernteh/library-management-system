...
<div class="container">
  ...
  if(isset($_SESSION['login_user']))
  {
      ...
      $sql= "SELECT student.username,roll,books.bookid,name,authors,edition,status FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bookid=books.bookid WHERE issue_book.approve =''";
